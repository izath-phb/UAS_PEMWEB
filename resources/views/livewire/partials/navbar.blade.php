<header
  class="flex z-[60] sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-white text-sm py-3 md:py-0 dark:bg-gray-800 shadow-md">
    ...
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        <a wire:navigate
          ...
          href="/" aria-label="Brand">Rumah Jahit Haifa</a>
        <div class="md:hidden">
          <button type="button"
        ...
        <div
          ...
          <div
            ...
            <a wire:navigate
              ...
              href="{{ route('index') }}" aria-current="page">Home</a>
