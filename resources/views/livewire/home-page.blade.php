      ...
      <div class="max-w-xl mx-auto">
        <div class="text-center ">
          ...
          <p class="mb-12 text-base text-center text-gray-500">
            Kepuasan Anda adalah prioritas kami. Simak pengalaman nyata dari pelanggan yang telah mempercayakan
            kebutuhan jahit
            mereka kepada Rumah Jahit Haifa — dari hasil rapi, pelayanan ramah, hingga ketepatan waktu yang selalu
            dijaga.
          </p>
        </div>
      </div>
