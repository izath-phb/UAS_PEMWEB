<div>
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
            Jahit Impianmu Bersama RUJ'HA – Elegan, Rapi, dan Berkualitas <span class="text-blue-600">Rumah Jahit Haifa
              (RUJ'HA)</span></h1>
          <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Rumah Jahit Haifa (RUJ'HA) adalah butik busana
            muslimah yang berlokasi di Kota Tegal, Jawa Tengah.
            Didirikan oleh Fitri nur hidayah pada tahun 2019 dengan produksi in-house yang menjaga kualitas jahitan dan
            desain yang
            elegan serta modern. </p>
  ...
  <section class="py-20 bg-white dark:bg-gray-900">
    <div class="max-w-xl mx-auto text-center px-4">
      ...
      <p class="mb-12 text-base text-gray-600 dark:text-gray-400">
        Jelajahi merek kain dan aksesori pilihan. Kami hanya menggunakan bahan dari merek terbaik
        untuk menjamin hasil yang elegan, tahan lama, dan nyaman dipakai. Kenali brand favorit pelanggan RUJ'HA.
      </p>
    </div>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brand->id }}">
          ...
          <div class="p-5 text-center">
            <a href="#" class="text-2xl font-bold text-gray-800 dark:text-gray-300">
              {{ $brand->name }}
            </a>
          </div>
        </div>
  ...
  <section class="bg-orange-200 py-20">
    <div class="max-w-xl mx-auto px-4 text-center">
      <div class="relative flex flex-col items-center">
        <h1 class="text-4xl sm:text-5xl font-bold text-gray-800 dark:text-gray-200">
      ...
      <p class="text-base text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
        Temukan kategori jahitan terbaik: baju harian, gamis elegan, seragam kerja, hingga busana pesta —
        semua tersedia dan bisa disesuaikan dengan keinginan Anda.
        Pilih kategori dan wujudkan gaya impian Anda bersama RUJ'HA.
      </p>
    </div>

    <div class="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto mt-16">
      <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @foreach ($categories as $category)
        <a href="/products?selected_categories[0]={{ $category->id }}" wire:key="{{ $category->name }}"
          class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition-all duration-300 dark:bg-slate-900 dark:border-gray-800">
          <div class="p-5">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <img class="h-10 w-10 rounded-full object-cover" src="{{ url('storage', $category->image) }}"
                  alt="{{ $category->name }}">
                <div class="ms-3">
                  <h3
              ...
              <svg class="w-5 h-5 text-gray-500 group-hover:text-blue-600 transition" fill="none" stroke="currentColor"
  ...
  <section class="py-14 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-6 mx-auto md:px-6">
      ...
      <div class="max-w-xl mx-auto mb-10 text-center">
        <h1 class="text-4xl sm:text-5xl font-bold text-gray-800 dark:text-gray-200">
          Customer<span class="text-blue-500">Testimonials</span>
        </h1>
        <!-- Bungkus dengan flex + justify-center -->
        ...
        <p class="text-base text-gray-500 dark:text-gray-400">
          Berikut adalah ulasan jujur dari pelanggan setia kami yang telah menggunakan produk kami.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 gap-6">
        <!-- Testimoni 1 -->
        <div class="py-6 px-6 bg-white rounded-md shadow dark:bg-gray-900">
          <div class="flex items-center mb-4">
            <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Avatar"
              class="w-12 h-12 rounded-full object-cover mr-4" />
            <div>
              <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Rina Andini</h4>
              <span class="text-sm text-gray-500 dark:text-gray-400">Jakarta, Indonesia</span>
            </div>
          </div>
          <p class="text-gray-600 dark:text-gray-300">
            Produk sangat berkualitas! Pelayanan cepat dan ramah. Saya pasti akan kembali belanja lagi.
          </p>
        </div>
        ...
        <div class="py-6 px-6 bg-white rounded-md shadow dark:bg-gray-900">
          <div class="flex items-center mb-4">
            <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Avatar"
              class="w-12 h-12 rounded-full object-cover mr-4" />
            <div>
              <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Dian Pratama</h4>
              <span class="text-sm text-gray-500 dark:text-gray-400">Bandung, Indonesia</span>
            </div>
          </div>
          <p class="text-gray-600 dark:text-gray-300">
            Saya suka tampilannya yang modern dan minimalis. Sangat cocok untuk kebutuhan bisnis saya.
          </p>
        </div>
        ...
        <div class="py-6 px-6 bg-white rounded-md shadow dark:bg-gray-900">
          <div class="flex items-center mb-4">
            ...
            <div>
              ...
              <span class="text-sm text-gray-500 dark:text-gray-400">Surabaya, Indonesia</span>
            </div>
          </div>
          <p class="text-gray-600 dark:text-gray-300">
            Pengalaman belanja yang menyenangkan. Barang cepat sampai dan sesuai dengan deskripsi.
          </p>
        </div>
        ...
        <div class="py-6 px-6 bg-white rounded-md shadow dark:bg-gray-900">
          <div class="flex items-center mb-4">
            <img src="https://randomuser.me/api/portraits/men/78.jpg" alt="Avatar"
              class="w-12 h-12 rounded-full object-cover mr-4" />
            <div>
              <h4 class="text-lg font-semibold text-gray-800 dark:text-white">Andi Wijaya</h4>
              <span class="text-sm text-gray-500 dark:text-gray-400">Yogyakarta, Indonesia</span>
            </div>
          </div>
          <p class="text-gray-600 dark:text-gray-300">
            Layanan pelanggan sangat responsif dan membantu ketika saya mengalami masalah.
          </p>
        </div>
      </div>
    </div>
